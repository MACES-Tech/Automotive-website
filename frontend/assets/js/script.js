(function($) {
	...
	$('.companyName span').hover(function () {
		$(this).siblings().removeClass('circle-text');
		$(this).addClass('circle-text');
		$('.values h3').siblings().removeClass('value_active');
		$('.values h3').addClass('value_inactive');
		$('#sec'+$(this).attr('id')).addClass('value_active')
	})
